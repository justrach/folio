...
const sourceName = (source: string) => ({keyword:"Question runs",evaluation:"Website evaluations",seo:"Search & backlinks","semantic-review":"Semantic reviews","agent-semantic-tool":"Agent TypeSafe checks","crawl-semantic-review":"Crawl Jev reviews"}[source] ?? source);

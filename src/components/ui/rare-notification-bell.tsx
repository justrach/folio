// Vendored from Rare UI by Swami Malode (MIT).
// Source: https://github.com/swamimalode07/rare-ui/blob/d146c35264c5905b995903d2d96cd6d188af114a/components/ui/notification-bell.tsx
// License: /LICENSES/rare-ui.txt
"use client";
...
// Use the same static presentation during SSR and the first hydration render.
...
export function NotificationBell({
  ...
  const reduced = !hydrated || Boolean(preference);
